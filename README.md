...
For first-time Windows setup in a cloned repository, the recommended starting point is:
...
For day-to-day local startup after setup, use:
...
The combined development entrypoint remains available for contributors who want both setup and control paths from one menu:
