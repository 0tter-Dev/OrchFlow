...
This project should not adopt a heavy Git Flow model in `v0.3.4`.
...
- patch increments, such as `0.3.3` to `0.3.4`, for fixes, small internal improvements, documentation refinements, test additions, and CI changes that do not redefine product scope
...
The selected frontend package manager for `v0.3.4` is `pnpm`.
...
The repository now has the backend and frontend quality baseline needed for `v0.3.4`.
