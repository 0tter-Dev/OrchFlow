...
Use this page to choose the shortest reliable route through OrchFlow documentation.

## Operator Route

1. [User Guide](./guides/user-guide.md)
2. [Lifecycle Management](./capabilities/lifecycle-management/README.md)
3. [Runtime Inspection](./capabilities/runtime-inspection/README.md)
4. [Installer And Releases](./guides/installer-and-releases.md)

## New Contributor Route

1. [Project Architecture](./PROJECT-ARCHITECTURE.md)
2. [Development Guide](./DEVELOPMENT-GUIDE.md)
3. [Documentation Guide](./DOCUMENTATION-GUIDE.md)
4. [Current Status](./STATUS.md)
5. [Git And GitHub Flow](./guides/git-and-github-flow.md)
...
- [Capabilities](./capabilities/): current product behavior and constraints.
- [Reference](./reference/): stable contracts and definitions.
- [Guides](./guides/): task- and audience-oriented instructions.
- [Decisions](./decisions/): durable architectural decisions.
- [Plans](./plans/): active, future, and completed work records.
