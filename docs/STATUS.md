...
OrchFlow is in the `v0.3.46` implementation stage as of `2026-09-23`. Persisted visual preferences are delivered; operational workspace hierarchy is the active delivery plan.
...
| Web operator workspace | in_progress | [Web Operator Workspace](./capabilities/web-operator-workspace/README.md) | [web-021 operational workspace hierarchy](./plans/active/web-021-operational-workspace-hierarchy.md) |
