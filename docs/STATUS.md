...
OrchFlow is in the `v0.3.36` implementation stage as of `2026-09-13`. Workspace internationalization is implemented, and critical browser workflow coverage is in active delivery.
...
| Configuration | in_progress | [Configuration](./capabilities/configuration/README.md) | — |
...
| Web operator workspace | in_progress | [Web Operator Workspace](./capabilities/web-operator-workspace/README.md) | [web-012](./plans/active/web-012-critical-browser-workflow-tests.md) |
