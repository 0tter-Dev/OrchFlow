...
1. **Project Registry And Mapping Management Completion**
...
2. **Runtime Inspection And History Maturity**
...
3. **Admin, Audit, And Permission Refinement**
...
4. **Web Operator Experience Completion**
...
5. **CI, Contracts, And Release Discipline**
...
- keep Windows `.bat` lifecycle scripts as the authoritative operational contract for managed projects in `v0.3.5`
