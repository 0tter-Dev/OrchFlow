...
1. **Web Guided Onboarding Polish**
    Add the next focused onboarding improvement to the authenticated web workspace, keeping lifecycle readiness guidance clear after the backend contracts are stable.

2. **CI, Contracts, And Release Discipline**
...
- keep Windows `.bat` lifecycle scripts as the authoritative operational contract for managed projects in `v0.3.13`
