...
1. **Web Operator Experience Completion**
    Expand the web workspace with broader guided onboarding polish after the backend contracts are stable.
...
- keep Windows `.bat` lifecycle scripts as the authoritative operational contract for managed projects in `v0.3.12`
