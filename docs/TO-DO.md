...
1. `docs(installer): define Windows bootstrap executable implementation plan`
...
2. `feat(installer): add Windows bootstrap executable prototype`
...
- keep Windows `.bat` lifecycle scripts as the authoritative operational contract for managed projects in `v0.3.30`
