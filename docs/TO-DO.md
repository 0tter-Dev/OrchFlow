...
1. **Analysis Proposal Without File Writes**
...
2. **Review, Validation, And Approval Workflow**
...
3. **Approved `.bat` File Generation And Mapping Persistence**
...
4. **Project Registry And Mapping Management Completion**
...
5. **Runtime Inspection And History Maturity**
...
6. **Admin, Audit, And Permission Refinement**
...
7. **Web Operator Experience Completion**
...
8. **CI, Contracts, And Release Discipline**
...
- keep Windows `.bat` lifecycle scripts as the authoritative operational contract for managed projects in `v0.3.2`
