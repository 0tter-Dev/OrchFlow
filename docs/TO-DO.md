...
1. `docs(brand): define OrchFlow visual identity direction`
...
2. `docs(installer): outline Windows installer and release matrix`
...
- keep Windows `.bat` lifecycle scripts as the authoritative operational contract for managed projects in `v0.3.28`
