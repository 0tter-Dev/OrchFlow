...
1. **Runtime Inspection And History Maturity**
...
2. **Admin, Audit, And Permission Refinement**
...
3. **Web Operator Experience Completion**
...
4. **CI, Contracts, And Release Discipline**
...
- keep Windows `.bat` lifecycle scripts as the authoritative operational contract for managed projects in `v0.3.6`
