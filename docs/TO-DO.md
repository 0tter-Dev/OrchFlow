...
1. **Approved `.bat` File Generation And Mapping Persistence**
...
2. **Project Registry And Mapping Management Completion**
...
3. **Runtime Inspection And History Maturity**
...
4. **Admin, Audit, And Permission Refinement**
...
5. **Web Operator Experience Completion**
...
6. **CI, Contracts, And Release Discipline**
...
- keep Windows `.bat` lifecycle scripts as the authoritative operational contract for managed projects in `v0.3.4`
