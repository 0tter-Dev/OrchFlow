...
1. **Web Operator Experience Completion**
    Expand the web workspace with AI proposal review, richer error states, guided onboarding, and clearer runtime diagnostics after the backend contracts are stable.
...
- keep Windows `.bat` lifecycle scripts as the authoritative operational contract for managed projects in `v0.3.9`
