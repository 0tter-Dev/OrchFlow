...
1. **Admin, Audit, And Permission Refinement**
...
2. **Web Operator Experience Completion**
...
3. **CI, Contracts, And Release Discipline**
...
- keep Windows `.bat` lifecycle scripts as the authoritative operational contract for managed projects in `v0.3.7`
