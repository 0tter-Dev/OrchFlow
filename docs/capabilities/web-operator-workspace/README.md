...
- visual complexity should remain secondary to operational clarity in `v0.3.44`; the web workspace should feel like a focused operator tool rather than a marketing or bootstrap page
