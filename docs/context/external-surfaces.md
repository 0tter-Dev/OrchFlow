...
- CLI and API both expose authentication, project registry, lifecycle execution, runtime inspection, admin audit history visibility, admin user updates, and project owner management
