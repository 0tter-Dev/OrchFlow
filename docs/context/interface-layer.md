...
- visual complexity should remain secondary to operational clarity in `v0.3.27`; the web workspace should feel like a dense operator tool rather than a marketing or bootstrap page
