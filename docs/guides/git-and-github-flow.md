...
This project should not adopt a heavy Git Flow model in `v0.3.40`.
...
The repository now has the backend and frontend quality baseline needed for `v0.3.40`.
