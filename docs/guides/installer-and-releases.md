...
- verify required local prerequisites: `uv`, Node.js `24` LTS, and its bundled Corepack; Corepack resolves the pnpm `12.4.1` project pin without global shim writes
